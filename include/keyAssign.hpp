...
KeyAssign keyAssign[] = {
    // MODE 1
    {
        ...
        K_PD_TRG_B, K_NOP, K_NOP, K_NOP, K_NOP, K_NOP, KEY_ICON_NONE,
    ...
    // MODE 2 GRADIUS
    {
        ...
        K_KB_LEFT, K_KB_TENKEY_4, K_NOP, K_NOP, K_NOP, K_NOP, KEY_ICON_LEFT,
        K_KB_UP, K_KB_TENKEY_8, K_NOP, K_NOP, K_NOP, K_NOP, KEY_ICON_UP,
        K_KB_RIGHT, K_KB_TENKEY_6, K_NOP, K_NOP, K_NOP, K_NOP, KEY_ICON_RIGHT,
        K_NOP, K_NOP, K_NOP, K_NOP, K_NOP, K_NOP, KEY_ICON_NONE,
